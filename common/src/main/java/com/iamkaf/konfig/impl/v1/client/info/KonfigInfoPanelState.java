...
@ApiStatus.Internal
public final class KonfigInfoPanelState {
    ...
    public KonfigInfoPanelState(List<EntryRef> entries) {
        this.entries = entries;
    }

    public void beginFrame(KonfigInfoPanelBounds bounds, int mouseX, int mouseY) {
    ...
    public void setActiveDropdownOptionInfo(EntryRef entry, List<InfoPanelItem> info) {
    ...
    public List<InfoPanelItem> activeItems(DropdownSelectionInfo dropdownSelectionInfo) {
    ...
    public void updateContent(List<InfoPanelItem> items, int contentHeight, int viewportHeight) {
    ...
    public boolean handleScroll(KonfigInfoPanelBounds bounds, double mouseX, double mouseY, double scrollY) {
    ...
    public String clickedLink(KonfigInfoPanelBounds bounds, double mouseX, double mouseY) {
    ...
    public void addLink(int x, int y, int width, int height, String target) {
    ...
    public interface DropdownSelectionInfo {
