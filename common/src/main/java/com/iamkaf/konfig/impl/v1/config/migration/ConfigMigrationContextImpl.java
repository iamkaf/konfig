...
@ApiStatus.Internal
public final class ConfigMigrationContextImpl implements ConfigMigrationContext {
    ...
    public ConfigMigrationContextImpl(String modId, String name, int fromVersion, int toVersion, CommentedConfig root) {
        this.modId = modId;
        this.name = name;
