...
@ApiStatus.Internal
final class KonfigRegistrySuggestionController {
    ...
    KonfigRegistrySuggestionController(Owner owner) {
        this.owner = owner;
    }

    void updateInputBounds(int x, int y, int width) {
        this.inputX = x;
        this.inputY = y;
    ...
    void render(KonfigRenderContext context, int mouseX, int mouseY) {
